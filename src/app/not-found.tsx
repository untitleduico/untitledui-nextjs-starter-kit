        ...
        <div className="flex w-full max-w-3xl flex-col gap-8 md:gap-12">
          <div className="flex flex-col gap-4 md:gap-6">
            <div className="flex flex-col gap-3">
              <span className="font-semibold text-brand-secondary text-md">
                404 error
              </span>
              <h1 className="font-semibold text-display-md text-primary md:text-display-lg lg:text-display-xl">
          ...
          <div className="flex flex-col-reverse gap-3 sm:flex-row">
            ...
            <Button onClick={() => router.back()} size="xl">
              Take me home
            </Button>
          </div>
        </div>

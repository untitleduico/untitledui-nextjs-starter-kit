    ...
    <AriaModalOverlay
      ...
      className={(state) =>
        cx(
          ...
          state.isEntering && "fade-in animate-in duration-300",
          state.isExiting && "fade-out animate-out duration-500",
  ...
  <AriaModal
    ...
    className={(state) =>
      cx(
        ...
        state.isEntering && "slide-in-from-right animate-in duration-300",
        state.isExiting && "slide-out-to-right animate-out duration-500",
        typeof props.className === "function"
          ? props.className(state)
          : props.className
      )
...
export const Dialog = (props: DialogProps) => (
  <AriaDialog
    ...
    {...props}
    className={cx(
      "relative flex size-full flex-col items-start gap-6 overflow-y-auto bg-primary outline-hidden ring-1 ring-secondary_alt",
      props.className
    )}
  />
);

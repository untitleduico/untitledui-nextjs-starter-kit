                ...
                <div className="mx-auto grid max-w-3xl gap-6 md:grid-cols-3 md:gap-8">
                    {privacy.features.map((feature) => {
                        ...
                        return (
                            ...
                            >
                                {/* Icon */}
                                <div className="mb-4 flex size-16 items-center justify-center rounded-2xl bg-ink text-white transition-all group-hover:bg-brand-600">
                                    <Icon className="size-7" />
                                </div>

                                {/* Title - mono uppercase */}
                                <h3 className="mb-2 font-mono text-sm font-semibold uppercase tracking-wide text-ink">
                                    {feature.title}
                                </h3>

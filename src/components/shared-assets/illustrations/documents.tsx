  ...
  return (
    <div {...otherProps} className={cx("relative h-30 w-40.25", className)}>
      <svg
        ...
        viewBox="0 0 161 120"
      >
        <circle className="fill-utility-gray-100" cx="27" cy="11" r="5" />
        <circle className="fill-utility-gray-100" cx="24" cy="109" r="7" />
        <circle className="fill-utility-gray-100" cx="151" cy="35" r="7" />
        <circle className="fill-utility-gray-100" cx="140" cy="8" r="4" />
        <circle className="fill-utility-gray-100" cx="82" cy="52" r="52" />
        ...
        <defs>
          ...
          <linearGradient
            ...
            y2="31.4527"
          >
            <stop className="text-utility-gray-100" stopColor="currentColor" />
            <stop
  ...
  return (
    <div {...otherProps} className={cx("relative h-34.25 w-46.25", className)}>
      <svg
        ...
        viewBox="0 0 185 137"
      >
        <circle className="fill-utility-gray-100" cx="95" cy="64" r="64" />
        <circle className="fill-utility-gray-100" cx="29" cy="12" r="6" />
        <circle className="fill-utility-gray-100" cx="26" cy="112" r="8" />
        <circle className="fill-utility-gray-100" cx="173" cy="96" r="8" />
        <circle className="fill-utility-gray-100" cx="158" cy="9" r="5" />
        ...
        <g filter="url(#documents-shadow-02-md)">
          ...
          <path
            ...
            strokeWidth="0.5"
          />
          <path className="fill-utility-gray-200" d="M109 10L121 22H109V10Z" />
        </g>
  ...
  return (
    <div {...otherProps} className={cx("relative h-41.5 w-57.5", className)}>
      <svg
        ...
        viewBox="0 0 230 166"
      >
        <circle className="fill-utility-gray-100" cx="118" cy="80" r="80" />
        <circle className="fill-utility-gray-100" cx="34" cy="20" r="8" />
        <circle className="fill-utility-gray-100" cx="206" cy="126" r="6" />
        <circle className="fill-utility-gray-100" cx="33" cy="138" r="10" />
        <circle className="fill-utility-gray-100" cx="218" cy="38" r="10" />
        <circle className="fill-utility-gray-100" cx="199" cy="11" r="7" />

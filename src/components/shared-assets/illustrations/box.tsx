  ...
  return (
    <div {...otherProps} className={cx("relative h-31.5 w-38", className)}>
      <svg
        ...
        viewBox="0 0 152 126"
      >
        <circle className="fill-utility-gray-100" cx="76" cy="60" r="52" />
        <circle className="fill-utility-gray-100" cx="21" cy="27" r="5" />
        <circle className="fill-utility-gray-100" cx="18" cy="111" r="7" />
        <circle className="fill-utility-gray-100" cx="145" cy="43" r="7" />
        <circle className="fill-utility-gray-100" cx="134" cy="16" r="4" />
  ...
  return (
    <div {...otherProps} className={cx("relative h-37 w-43", className)}>
      <svg
        ...
        viewBox="0 0 172 148"
      >
        <circle className="fill-utility-gray-100" cx="86" cy="74" r="64" />
        <circle className="fill-utility-gray-100" cx="20" cy="30" r="6" />
        <circle className="fill-utility-gray-100" cx="17" cy="122" r="8" />
        <circle className="fill-utility-gray-100" cx="160" cy="46" r="8" />
        <circle className="fill-utility-gray-100" cx="149" cy="19" r="5" />
  ...
  return (
    <div {...otherProps} className={cx("relative h-45.25 w-55", className)}>
      <svg
        ...
        viewBox="0 0 220 181"
      >
        <circle className="fill-utility-gray-100" cx="110" cy="90" r="80" />
        <circle className="fill-utility-gray-100" cx="26" cy="30" r="8" />
        <circle className="fill-utility-gray-100" cx="198" cy="136" r="6" />
        <circle className="fill-utility-gray-100" cx="25" cy="148" r="10" />
        <circle className="fill-utility-gray-100" cx="210" cy="56" r="10" />
        <circle className="fill-utility-gray-100" cx="191" cy="21" r="7" />

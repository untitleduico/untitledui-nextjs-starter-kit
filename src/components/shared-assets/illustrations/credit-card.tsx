  ...
  return (
    <div {...otherProps} className={cx("relative h-29.5 w-38", className)}>
      <svg
        ...
        viewBox="0 0 152 118"
      >
        <circle className="fill-utility-gray-100" cx="21" cy="5" r="5" />
  ...
  return (
    <div {...otherProps} className={cx("relative h-35.75 w-45", className)}>
      <svg
        ...
        viewBox="0 0 180 143"
      >
        <circle className="fill-utility-gray-100" cx="90" cy="64" r="64" />
        <circle className="fill-utility-gray-100" cx="24" cy="6" r="6" />
        <circle className="fill-utility-gray-100" cx="21" cy="112" r="8" />
        <circle className="fill-utility-gray-100" cx="164" cy="36" r="8" />
        <circle className="fill-utility-gray-100" cx="153" cy="9" r="5" />
        <g filter="url(#credit-card-shadow-md)">
          ...
          />
          <circle className="fill-utility-gray-300" cx="137" cy="42" r="10" />
          <circle className="fill-utility-gray-200" cx="125" cy="42" r="10" />
          <path
            className="fill-utility-gray-300"
  ...
  return (
    <div {...otherProps} className={cx("relative h-41.75 w-55", className)}>
      ...
      >
        ...
        <circle className="fill-utility-gray-100" cx="18" cy="12" r="8" />
        <circle className="fill-utility-gray-100" cx="198" cy="142" r="6" />
